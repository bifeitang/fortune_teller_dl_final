...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str, default='./Demo_images',
                        help='directory for train images')
    parser.add_argument('--output_dir', type=str, default='./Demo_images/',
                        help='directory for saving resized images')
    
    parser.add_argument('--image_size', type=int, default=224, # for cropping purpose
